//-----------------------------------------------------------------------
// <copyright file="SignalToLongNameConverter.cs" company="Xcoder Software">
//     Author: Gil Yoder
...
namespace R8LocoCtrl.Tools
{
    ...
    public class SignalToLongNameConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (signalInstructions)
            {
                ...
                case SignalInstructions.ApproachMediumDoubleYellow:
                    return "Approach Medium Double Yellow";
                ...
                case SignalInstructions.MediumAdvanceApproach:
                    return "Medium Advance Approach";
                ...
                case SignalInstructions.DivergingApproachDiverging:
                    return "Diverging Approach Diverging";

                case SignalInstructions.DivergingApproachMedium:
                    return "Diverging Approach Medium";
                ...
                case SignalInstructions.DivergingApproachRestricting:
                    return "Diverging Approach Restricting";
